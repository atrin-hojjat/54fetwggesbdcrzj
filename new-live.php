...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  if (hash("sha256", $_POST['password']) == "a87a5843b906488216ff1614dee5b5b3a59470163617f462061f9cba863b535b") {
    $prep = $conn->prepare("INSERT INTO `puz_liveshows`(`name`, `date`, `school`, `player1`, `player2`) VALUES(?, ?, ?, ?, ?)");
    $prep->bind_param("sssss", $_POST['name'], $_POST['date'], $_POST['school'], $_POST['InputPlayer1'], $_POST['InputPlayer2']);
    $prep->execute();
    $prep->close();
            ...
            <div class="card-body">
              ...
              <form class="form-signin" url="/new-live.php" method="post">
                ...
                <div class="form-group text-right">
                  <label for="InputPlayer1">پلیر اول:</label>
                  <textarea class="form-control" id="InputPlayer1" rows="5" name="InputPlayer1" required></textarea>
                </div>
                <div class="form-group text-right">
                  <label for="InputPlayer2">پلیر دوم:</label>
                  <textarea class="form-control" id="InputPlayer2" rows="5" name="InputPlayer2" required></textarea>
                </div>
