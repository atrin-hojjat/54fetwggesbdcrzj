					...
					<div class="card-body">
						<div class="container">
							<div class="row text-right">
								...
								<h4 class="w-100 mt-3">توضیحات ارور‌ها:</h4>
								<ul>
									<li>Error Code 232011: لایو هنوز شروع نشده یا به دلیل حجم بازدید لحظه ای قطع شده. راه حل، ریفرش کردن صفحه است.</li>
									<li>در صورت مواجهه با ارور های دیگر با کلیک بر روی دکمه نارنجی رنگ پایین سمت راست با پشتیبانی در تماس باشید.</li>
								</ul>
							</div>
						</div>
					</div>
